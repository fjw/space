...
#gource --date-format "%d.%m.%Y" --file-idle-time 0 --auto-skip-seconds 1 -1920x1080 --stop-at-end --output-ppm-stream - | ffmpeg -an -y -r 60 -f image2pipe -vcodec ppm -i - -vcodec libx264 -preset veryslow -crf 16 hirmer_eshops_history.avi
